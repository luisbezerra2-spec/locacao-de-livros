        ...
        <div class="row">
            <div class="offset-2 col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="offset-2 col-8">
                            <form action="{{ route('salvarDisciplina') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="carga_horaria" class="form-control" required id="carga_horaria" >  
                                </div>

                                <div class="mb-3">
                                    <label for="periodo" class="form-label">Periodo</label>
                                    <input type="text" name="periodo" required class="form-control" id="periodo" >  
                                </div>

                                <div class="mb-3">
                                    <label for="professor" class="form-label">Professor</label>

                                    <select name="docente_id" class="form-select" aria-label="Default select example">
