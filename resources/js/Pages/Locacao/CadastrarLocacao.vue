        ...
        <form @submit.prevent="submit" class="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select v-model="form.leitor_id"
                        class="w-full rounded-lg border border-gray-300 px-4 py-3 cursor-pointer">
                        <option value="">
                            Selecione um leitor
                        </option>

                        <option v-for="leitor in leitores" :key="leitor.id" :value="leitor.id">
                            {{ leitor.nome }}
                        </option>
                    </select>

                    <p v-if="form.errors.leitor_id" class="text-red-500 text-sm mt-1">
                ...
                <div>
                    ...
                    <select v-model="form.livro_id" class="w-full rounded-lg border border-gray-300 px-4 py-3">
                        <option value="">
                            Selecione um livro
                        </option>
                    ...
                    <p v-if="form.errors.livro_id" class="text-red-500 text-sm mt-1">
