...
Route::put('atualizarLivro', [LivroController::class, 'atualizarLivro'])->name('atualizarLivro');
...
Route::put('atualizarLeitor', [LeitorController::class, 'atualizarLeitor'])->name('atualizarLeitor');
